...
import IconMenuElements from "../icon/menu/icon-menu-elements";
...
import IconMenuTables from "../icon/menu/icon-menu-tables";
...
import IconMenuPages from "../icon/menu/icon-menu-pages";
import IconMenuAuthentication from "../icon/menu/icon-menu-authentication";
                ...
                >
                  <ul className="sub-menu text-gray-500">
                    ...
                    <li className="menu nav-item">
                      <button
                        type="button"
                        className={`${errorSubMenu ? "open" : ""} w-full before:h-[5px] before:w-[5px] before:rounded before:bg-gray-300 hover:bg-gray-100 ltr:before:mr-2 rtl:before:ml-2 dark:text-[#888ea8] dark:hover:bg-gray-900`}
