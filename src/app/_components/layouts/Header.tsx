...
import IconChatNotification from "../icon/icon-chat-notification";
...
import IconMenuMore from "../icon/menu/icon-menu-more";
                        ...
                        {messages.map((message) => {
                          return (
                            ...
                            >
                              ...
                              <span className="whitespace-pre rounded bg-white-dark/20 px-1 font-semibold text-dark/60 ltr:ml-auto ltr:mr-2 rtl:ml-2 rtl:mr-auto dark:text-white-dark">{message.time}</span>
                              <button
                                type="button"
